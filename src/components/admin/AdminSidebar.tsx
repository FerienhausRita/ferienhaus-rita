...
const NAV_GROUPS: { title: string | null; hrefs: string[] }[] = [
  {
    title: "Tagesgeschäft",
    hrefs: ["/admin", "/admin/buchungen", "/admin/kalender", "/admin/zahlungen", "/admin/rechnungen"],
  },
  {
    title: "Gäste & Kommunikation",
    hrefs: ["/admin/gaeste", "/admin/nachrichten", "/admin/chat", "/admin/warteliste"],
  },
  {
    title: "Betrieb",
    hrefs: ["/admin/reinigung", "/admin/aufgaben"],
  },
  {
    title: "Website",
    hrefs: ["/admin/wohnungen", "/admin/fotos"],
  },
  {
    title: null,
    hrefs: ["/admin/einstellungen"],
  },
];
...
export default function AdminSidebar({ userName, userEmail }: AdminSidebarProps) {
  ...
  return (
    <aside className="admin-sidebar hidden md:flex flex-col w-64 bg-white border-r border-stone-200 h-screen fixed left-0 top-0 z-30">
      {/* Header */}
      <div className="p-6 border-b border-stone-100">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#c8a96e] rounded-xl flex items-center justify-center flex-shrink-0">
            <span className="text-white font-serif text-sm font-bold">FR</span>
          </div>
          <div className="min-w-0">
            <h1 className="font-serif font-bold text-stone-900 text-sm truncate">
              Ferienhaus Rita
            </h1>
      ...
      <nav className="flex-1 py-4 px-3 overflow-y-auto">
        {NAV_GROUPS.map((group) => {
          ...
          return (
            <div key={group.title || "_"} className="mb-4 last:mb-0">
              {group.title && (
