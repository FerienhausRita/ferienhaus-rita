...
import { deleteChatConversation } from "@/app/(admin)/admin/actions";
        ...
        {selected ? (
          <>
            ...
            <div className="p-4 border-b border-stone-100 flex items-center justify-between">
              ...
              <button
                onClick={async () => {
                  if (!confirm("Konversation unwiderruflich löschen? Alle Nachrichten gehen verloren.")) return;
                  const result = await deleteChatConversation(selected.id);
                  if (result.success) {
